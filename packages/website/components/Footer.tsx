...
export default function Footer() {
  const navigation = {
    solutions: [
      ...
      { name: 'Quality Analysis', href: '#' },
      { name: 'Regression Detection', href: '#' },
    ],
    resources: [
    ...
    company: [
      ...
      { name: 'Careers', href: '#' },
      { name: 'Contact', href: '#' },
      { name: 'GitHub', href: 'https://github.com/justcopyai/bagula.ai' },
    ],
    legal: [
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              ...
              <p className="text-sm text-neutral-600">
                © {new Date().getFullYear()} Bagula. All rights reserved.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              <a href="https://github.com/justcopyai/bagula.ai" className="text-neutral-400 hover:text-neutral-600 transition-colors">
